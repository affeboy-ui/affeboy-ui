...
_G.animBubblyActive = not _G.animBubblyActive
...
local function applyBubblyAnimations(animate)
...
local function toggleAnimations()
    ...
    if _G.animBubblyActive then
        print("Applying bubbly animations...")
        applyBubblyAnimations(animate)
        notifyUser("Bubbly Animations Loaded", "🎭 Hexploit 🎭")
    else
