...
_G.animMageActive = not _G.animMageActive
...
local function applyMageAnimations(animate)
...
local function toggleAnimations()
    ...
    if _G.animMageActive then
        print("Applying Mage animations...")
        applyMageAnimations(animate)
        notifyUser("Mage Animations Loaded", "🎭 Hexploit 🎭")
    else
